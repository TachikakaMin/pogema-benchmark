...
from follower.utils import fix_num_threads_issue
...
from follower.follower_python.register_training_utils import register_custom_model
...
class FollowerInferenceConfig(AlgoBase, extra=Extra.forbid):
    ...
    path_to_weights: str = "follower/model/follower"
