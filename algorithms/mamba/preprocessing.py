...
from follower.follower_python.planning import ResettablePlanner, PlannerConfig
...
def mamba_preprocessor(env, algo_config):
    env = wrap_preprocessors(env, algo_config.preprocessing)
    return env
